...
public class CrearTransferenciasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crear_transferencias);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.activity_crear_transferencia, menu);
        return true;
    }
        ...
        switch (item.getItemId()) {
            case R.id.mnGuardar:
                if (!etCant.getText().toString().isEmpty()) {
                    ...
                    result.putExtra(TransferenciasActivity.VALUE_CANTIDAD, etCant.getText().toString());

                    Almacen almacen = (Almacen) spAlmacen.getSelectedItem();
                    result.putExtra(TransferenciasActivity.VALUE_IDALMACEN, almacen.getId());

                    Producto producto = (Producto) spProducto.getSelectedItem();
                    result.putExtra(TransferenciasActivity.VALUE_IDPRODUCTO, producto.getId());
